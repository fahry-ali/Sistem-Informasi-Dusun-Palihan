      ...
      <div class="card w-100">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col-6">
                    <h5 class="card-title fw-semibold text-white">Tambah Perangkat Dusun</h5>
                </div>
               ...
               <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <label for="foto" class="form-label">Foto Perangkat Dusun <span style="color: red">*</span></label>
